           ...
           return DataTables::of($query)
                ->addColumn('action' , function($row){
                    $html = '<button type="button" data-href="'.route('banks.edit',$row->id).'" class="btn btn-outline-info btn-not-radius modal-btn edit_bank btn-hover"><i class="fa fa-edit"></i></button>&nbsp;
                            <button type="button" data-href="'.route('banks.destroy',$row->id).'" data-account="'.$row->account_name.'" class="btn btn-outline-danger btn-not-radius delete-btn delete_bank btn-hover" ><i class="fa fa-trash"></i></button>';
                    return $html;
                })
