                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="account_name" id="account_name" placeholder="{{ __('Full name') }}">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="form-control-label" for="basic-url">{{ __('Bank number') }}</label><b class="text-danger">*</b>
                            <input type="text" class="form-control" name="account_number" id="account_number" placeholder="{{ __('Bank number') }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="bank_name" id="bank_name" placeholder="{{ __('Bank name') }}">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="form-control-label" for="basic-url">{{ __('Branch') }}</label><b class="text-danger">*</b>
                            <input type="text" class="form-control" name="branch" id="branch" placeholder="{{ __('Branch') }}">
                        </div>
                    </div>
                </div>
                <div class="row">
