...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">{{ __('List banks') }}</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">{{ __('Home') }}</a></li>
            <li class="breadcrumb-item active">{{ __('List banks') }}</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-8 group-btn text-right">
                            ...
                            data-href="{{ route('banks.create') }}"><i class="fa fa-plus"></i> {{ __('Add bank') }}</button>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width: 18%">{{ __('Bank number') }}</th>
                            <th style="width: 18%">{{ __('Bank name') }}</th>
